...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
             ...
             */
            Log.e(TAG, "onCreate::Can't create a ServerSocket" + e.toString());
            return;
        }
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {			
				...
				while(true) {
					...
					//Log.d(TAG, "out:" + out + "::in:" + in + "::line=" + in.readLine());
					
				while( (inputLine=in.readLine()) != null) {
					Log.d(TAG, "ServerTask:doInBackground::" + inputLine);
        ...
        protected void onProgressUpdate(String...strings) {
        	Log.d(TAG,"ServerTask:onProgressUpdate");
            /*
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
            	Log.i(TAG, "ClientTask : doInBackground");
                ...
                Log.d(TAG, "ClientTask : doInBackground::msg=" + msgToSend);
                /*
                ...
                Log.e(TAG, "ClientTask UnknownHostException::"+e.toString());
            } catch (IOException e) {
